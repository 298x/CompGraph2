...
void RenderScene() {
	...
	// Матрица вращения
	mat4x4 World;
	World[0][0] = cosf(Scale); World[0][1] = -sinf(Scale); World[0][2] = 0.0; World[0][3] = 0.0;
	World[1][0] = sinf(Scale); World[1][1] =  cosf(Scale); World[1][2] = 0.0; World[1][3] = 0.0;
	World[2][0] = 0.0;		   World[2][1] = 0.0;          World[2][2] = 1.0; World[2][3] = 0.0;
	World[3][0] = 0.0;         World[3][1] = 0.0;          World[3][2] = 0.0; World[3][3] = 1.0;

	// Описание треугольника и его вращение
	vec3 Vertices[3];
