...
// Урок 8 - Преобразования масштаба
...
void RenderScene() {
	...
	// Матрица масштаба
	mat4x4 World;
	World[0][0] = abs(sinf(Scale)); World[0][1] = 0.0;               World[0][2] = 0.0;              World[0][3] = 0.0;
	World[1][0] = 0.0;              World[1][1] = abs(cosf(Scale));  World[1][2] = 0.0;              World[1][3] = 0.0;
	World[2][0] = 0.0;		World[2][1] = 0.0;               World[2][2] = abs(sinf(Scale)); World[2][3] = 0.0;
	World[3][0] = 0.0;              World[3][1] = 0.0;               World[3][2] = 0.0;              World[3][3] = 1.0;

	// Описание треугольника и изменение его масштаба
	vec3 Vertices[3];
